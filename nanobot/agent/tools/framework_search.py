...
class FrameworkSearchTool(Tool):
    ...
    description = (
        ...
        "- memory_search searches experiential knowledge (for reference only)\n"
        "- framework_search searches framework docs and rules (must be obeyed)\n\n"
        "**Difference from conversation_search**:\n"
        "- conversation_search searches conversation history (factual records)\n"
        "- framework_search searches built-in framework documentation (authoritative rules)\n\n"
        "**Note**:\n"
