...
def build_subagent_prompt(
    ...
    parts.append(
        ...
        "### Team Communication\n\n"
        "The Quality Principle above — pursue the best outcome — applies to the whole team, "
        "not just your individual task. You are part of a team. Other Workers may be running "
        "in parallel, each working on their piece of a larger goal. Your best work multiplied "
        "by coordination produces the system's best output.\n\n"
        "**Share findings proactively.** If you discover a better approach, a pitfall, "
        "or something that changes the plan — tell the Orchestrator immediately. "
        "A finding you keep to yourself helps no one; shared, it makes every downstream "
        "decision better. Use `notify_orchestrator(msg, priority)` — it's fire-and-forget, "
        "call it and continue working.\n\n"
        "**Ask when uncertain.** If you need input to produce the right result, "
        "use `request_orchestrator_input(question, context)`. Your iteration budget pauses "
        "while waiting — you don't lose progress. A wrong output is worse than a brief pause "
        "to get it right.\n\n"
        ...
        "Write your own findings, blockers, and insights there. The shared board is how "
        "the team compounds knowledge — one Worker's discovery becomes everyone's advantage.\n\n"
        "**The goal is not 'finish my task'. The goal is 'the team delivers the best result'.** "
        "Communication is not overhead — it's how you amplify your own work across the whole system.\n\n"
        "### Output Format\n\n"
