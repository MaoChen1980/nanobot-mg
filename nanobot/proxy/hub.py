...
class HubTCPServer:
    ...
    def _make_progress_callback(
        ...
        """Build a progress callback that delivers tool events to a proxy connection.

        This is shared between the main route path and /stop handling.
        Streaming text content is NOT delivered here — only the final response
        is sent via _route_message.
        """
        ...
        async def _on_progress(
            ...
            *,
            ...
            # Plain streaming content with no tool context → ignore.
            # Final response is delivered via _route_message.
