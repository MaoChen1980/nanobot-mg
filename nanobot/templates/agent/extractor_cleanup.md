...
你将收到一个或多个文件的完整内容。除了 `{{ workspace_path }}/SOUL.md` 和 `{{ workspace_path }}/USER.md`，可能还会收到按 topic 分类的主题文件（如 `Python/build.md`、`Project/nanobot.md` 等）。所有收到的文件都可以修改——主题文件的修改规则与 SOUL.md/USER.md 相同。
