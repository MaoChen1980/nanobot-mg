...
4. 更新 `{{ workspace_path }}/tasks/tree.json` / `{{ workspace_path }}/tasks/CURRENT.md` — 推进任务状态
5. 动态调整其他运行中的 subagent
6. 规划下一步 — 读 `{{ workspace_path }}/tasks/tree.json`，直接 spawn_tool 不等不积压
...
**常用工具:**
- team_board.md — **当前项目**事实共享板，所有 Subagent 可见，开工前先读。归档后清空
