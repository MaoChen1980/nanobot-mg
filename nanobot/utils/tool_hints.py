...
_TOOL_FORMATS: dict[str, tuple[list[str], str, bool, bool]] = {
    ...
    "move_file_tool":      (["source", "src"],                  "move {}",          True,  False),
    "glob_tool":      (["pattern"],                        'glob "{}"',        False, False),
    "grep_tool":      (["pattern"],                        'grep "{}"',        False, False),
    ...
    "spawn_tool":          (["task"],                           'spawn("{}")',      False, False),
    "diagnose_tool":       (["error", "target"],                'diagnose("{}")',   False, False),
