...
- Token is stored in `google_token.json` (scripts directory) and auto-refreshes.
- Pending OAuth session state/verifier are stored temporarily in `google_oauth_pending.json` until exchange completes.
