...
description: 'GitHub PR 代码审查：本地 diff 审查、远程 PR inline 评论。

  当用户要求审查 PR 代码、在 PR 中添加 inline 评论、或审查本地变更后推送时激活。'
version: 1.1.0
platforms:
- linux
- macos
...
```bash
# Run the inline setup block from the top of this skill
```
